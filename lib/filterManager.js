...
const { canCaptureFillerDuringPreferredPass } = require('./selectionConfig');
...
class FilterManager {
    ...
    constructor(inputFile, selectorConfig, progress = createProgressBar()) {
        this.filters = [];
        this.selection = [];
    ...
    registerFilter(Filter) {
        if (Filter.usesStandaloneFillerCapture === true) {
