...
Source: `.github/agents/b2c-dx-developer-tools-expert.agent.md`
Display name alias: `B2C DX Developer Tools Expert`
...
- `.agents/skills/b2c-extension-writing/SKILL.md`
- `.agents/skills/oclif-plugin-system/SKILL.md`
- `.agents/skills/catalog-reducer-filter-development/SKILL.md`
- `.agents/skills/catalog-reducer-verification/SKILL.md`
- `tmp/AGENTS.md`
- `tmp/README.md`
